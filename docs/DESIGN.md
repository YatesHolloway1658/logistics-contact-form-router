...
> Design notes for **logistics-contact-form-router** — a runnable typescript example that Typed Node/TypeScript service that routes logistics contact forms to team inboxes with zod validation.
...
- **Feature code** — the actual task: form submission to email.
